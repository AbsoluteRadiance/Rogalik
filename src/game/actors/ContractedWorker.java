 ...
 */
public class ContractedWorker extends Actor implements Flammable {
    ...
    /**
     * Receives burn damage. Called each turn by the {@link game.capabilities.Burn}
     * status effect while this worker is burning.
     *
     * @param damage the amount of burn damage to apply
     */
    @Override
